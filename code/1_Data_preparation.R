...
a3 <- read.xlsx("./data/raw_budburst_data.xlsx",
                sheet=6, startRow = 3, cols = 2:35)
a4 <- read.xlsx("./data/raw_budburst_data.xlsx",
                sheet=7, startRow = 3, cols = 2:35)
a5 <- read.xlsx("./data/raw_budburst_data.xlsx",
                sheet=8, startRow = 3, cols = 2:35)
a6 <- read.xlsx("./data/raw_budburst_data.xlsx",
                sheet=9, startRow = 3, cols = 2:35)
a7 <- read.xlsx("./data/raw_budburst_data.xlsx",
                sheet=10, startRow = 3, cols = 2:35)
a8 <- read.xlsx("./data/raw_budburst_data.xlsx",
                sheet=11, startRow = 3, cols = 2:35)
a9 <- read.xlsx("./data/raw_budburst_data.xlsx",
...
write.csv(e, file="./data/Summary_stats.csv")
...
w1 <- read.xlsx("./data/raw_weather_data.xlsx",
...
w2 <- read.xlsx("./data/raw_weather_data.xlsx",
...
w3 <- read.xlsx("./data/raw_weather_data.xlsx",
...
w4 <- read.xlsx("./data/raw_weather_data.xlsx",
...
w5 <- read.xlsx("./data/raw_weather_data.xlsx",
...
append_weather_f <- read.xlsx("./data/raw_weather_data.xlsx", sheet=1, startRow=12, 
                                cols=1:2)
...
gh <- read.xlsx("./data/raw_weather_data.xlsx",
...
saveRDS(tempdf, file="./data/weatherdata/La_wdf.Rda")
...
saveRDS(tempdf, file="./data/weatherdata/KoC_wdf.Rda")
...
saveRDS(tempdf, file="./data/weatherdata/Bi_wdf.Rda")
...
saveRDS(tempdf, file="./data/weatherdata/Re_wdf.Rda")
...
saveRDS(tempdf, file="./data/weatherdata/Sk_wdf.Rda")
...
saveRDS(tempdf, file="./data/weatherdata/KoM_wdf.Rda")
...
saveRDS(tempdf, file="./data/weatherdata/Sa_wdf.Rda")
...
saveRDS(tempdf, file="./data/weatherdata/Sw_wdf.Rda")
...
saveRDS(tempdf, file="./data/weatherdata/Ra_wdf.Rda")
...
# Write final file --------------------------------------------------------
write.csv(d, file="./data/Raw_combined_excel.csv")
...
saveRDS(tempdf, file="./data/weatherdata/All_weather_dataframe.Rda")
